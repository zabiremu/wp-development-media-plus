...
if (!function_exists('MediaPlusPro_wordpress_theme')) {
    function MediaPlusPro_wordpress_theme()
    {
        ...
        function MediaPlusPro_theme_enqueue_styles()
        {
            ...
            wp_enqueue_style('MediaPlusPro-responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(), wp_get_theme()->get("Version"));
        }

        // add_action('wp_enqueue_scripts', 'MediaPlusPro_custom_script_load');
        // function MediaPlusPro_custom_script_load()
        // {
